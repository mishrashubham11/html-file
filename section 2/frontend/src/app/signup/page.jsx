...
const SignupSchema = Yup.object().shape({   //copying from validation formik
  name: Yup.string()
        ...
        <div className="p-4 sm:p-7">
          ...
          <div className="mt-5">
            ...
            <form onSubmit={signupForm.handleSubmit}>
              {/* onsubmit is response and signup is varianble of aboue initialization */}
              <div className="grid gap-y-4">
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      type="password"
                      id="password"
                      // here under we del required and name and put values and onchange for formik and this change is for  every event on form
                      onChange={signupForm.handleChange}
                ...
                <div>
                  ...
                  {/* the above with curl bracut is for every field this show error for validation is not pass in box  */}
                </div>
                {/* End Form Group */}
                {/* Checkbox */}
